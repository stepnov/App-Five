...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/records/autocomplete`, { params });
  return response.data;
}

const RecordsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.records.hasPermissionToCreate,
});

export default connect(select)(RecordsSelectItem);
